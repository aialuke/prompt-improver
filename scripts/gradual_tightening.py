...
TIGHTENING_STAGES = {
    ...
    2: {
        ...
        "enable_rules": ["F401", "F811", "F823", "UP035"],
        "remove_ignores": ["F401"],
    ...
    3: {
        ...
        "enable_rules": ["ANN201", "ANN204", "ANN205", "RUF013"],
        "remove_ignores": ["ANN201"],
    ...
    4: {
        ...
        "enable_rules": ["PLR0912", "PLR0915", "PLR2004", "C901", "BLE001", "B904"],
        "remove_ignores": ["PLR0913", "PLR0915"],
    ...
    5: {
        ...
        "enable_rules": ["D100", "D103", "D104", "D107", "ANN001"],
        "remove_ignores": ["D100", "D103", "D104", "ANN001"],
    ...
    def show_metrics(self):
        ...
        if self.metrics_path.exists():
            ...
            for stage_num, stage_data in historical_metrics.get("stages", {}).items():
                ...
                print(
                    f"   Stage {stage_num}: {improvement.get('issues_fixed', 0)} issues fixed ({improvement.get('percentage_improvement', 0):.1f}% improvement)"
                )
