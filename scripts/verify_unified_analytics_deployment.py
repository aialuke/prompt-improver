...
class UnifiedAnalyticsVerifier:
    ...
    async def verify_import_structure(self) -> bool:
        ...
        try:
            ...
            from prompt_improver.analytics import create_analytics_service, AnalyticsServiceFacade
            ...
            try:
                from prompt_improver.analytics import AnalyticsService  # Should show deprecation warning
