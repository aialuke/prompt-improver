...
with open(roadmap_delta_path, encoding="utf-8") as f:
...
""".format(
    implementation_coverage=roadmap_delta["analysis_metadata"][
...
with open(roadmap_md_path, encoding="utf-8") as f:
...
if diff:
    repo.index.commit(
        "Update MCP_ROADMAP.md with progress tracker and integration guide"
    )
