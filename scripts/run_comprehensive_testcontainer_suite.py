...
class ComprehensiveTestSuite:
    ...
    def __init__(self, enable_ml: bool = True, enable_network: bool = True):
        ...
        self.ml_container: Optional[MLTestContainer] = None
        self.network_simulator: Optional[NetworkSimulator] = None
    ...
    async def run_container_health_checks(self) -> Dict[str, Any]:
        ...
        if self.ml_container:
            try:
                ...
                logger.error(f"✗ ML container health check failed: {e}")
        ...
        if self.network_simulator:
            try:
                ...
                logger.error(f"✗ Network simulator health check failed: {e}")
    ...
    async def run_service_validation_tests(self) -> Dict[str, Any]:
        ...
        if self.postgres_container:
            ...
            try:
                ...
                logger.error(f"✗ Database repository validation failed: {e}")
        ...
        if self.redis_container:
            ...
            try:
                ...
                logger.error(f"✗ Cache service validation failed: {e}")
        ...
        if self.ml_container:
            ...
            try:
                ...
                logger.error(f"✗ ML service validation failed: {e}")
