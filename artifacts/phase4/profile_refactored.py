...
def profile_refactored_logs():
    ...
    from prompt_improver.cli_refactored import LogDisplayOptions, LogViewerService, LogFilter, StaticLogReader, StandardLogStyler
    ...
    def simulate_refactored_log_processing():
        ...
        reader = StaticLogReader(console, styler, log_filter)
        ...
        with open(log_path) as f:
            ...
            for line in recent_lines:
                if log_filter.should_include_line(line):
                    ...
                    # Simulate formatting
                    formatted_line = f"[{color}]{line.rstrip()}[/{color}]"
...
def profile_refactored_health():
    ...
    from prompt_improver.cli_refactored import HealthCheckOptions, HealthDisplayFormatter
    from rich.console import Console
    
    def simulate_refactored_health_processing():
        ...
        formatter = HealthDisplayFormatter(console)
