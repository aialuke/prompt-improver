...
class SimpleAsyncPGPerformanceTest:
    ...
    async def run_performance_test(self):
        ...
        p95_basic = statistics.quantiles(basic_times, n=20)[18]  # 95th percentile
        ...
        # Test 3: JSONB Operations (APES-specific)
        ...
        # Test 4: MCP-style Read Operations
        ...
        # Based on typical asyncpg vs psycopg benchmarks
        simulated_psycopg_time = overall_avg * 1.25  # Assume psycopg was 25% slower
    ...
    async def _test_connection_establishment(self, iterations=50):
        ...
        for i in range(iterations):
            ...
            try:
                conn = await asyncpg.connect(self.database_url)
                await conn.fetchval("SELECT 1")  # Ensure connection is active
                await conn.close()
        ...
        for i in range(iterations):
            ...
            try:
                ...
                result = await conn.fetchval(
                    "SELECT $1::jsonb -> 'metadata' ->> 'confidence'",
                    test_jsonb
                )
    ...
    async def _test_concurrent_operations(self, concurrent_count=20, operations_per_worker=10):
        ...
        async def worker(worker_id):
            ...
            try:
                ...
                times = [100.0] * operations_per_worker  # Penalty
