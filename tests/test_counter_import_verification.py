...
from src.prompt_improver.learning.failure_analyzer import FailureModeAnalyzer, FailureConfig
...
class TestCounterImportVerification(unittest.TestCase):
    ...
    def test_no_typing_counter_import(self):
        ...
        for line in typing_import_lines:
            ...
            self.assertNotIn('Counter', line, 
                           f"Found Counter imported from typing in line: {line}")
    ...
    def test_prometheus_counter_is_aliased(self):
        ...
        self.assertIn('Counter as PrometheusCounter', source,
                     "Prometheus Counter should be aliased as PrometheusCounter")
        
        # Verify collections Counter is imported
        self.assertIn('from collections import', source,
                     "collections should be imported")
        self.assertIn('Counter', source.split('from collections import')[1].split('\n')[0],
