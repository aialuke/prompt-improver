...
class TestCoreContainerRealBehavior:
    ...
    async def test_core_container_factory_registration(self, core_container):
        ...
        core_container.register_factory(
            TestServiceProtocol,
            test_factory,
    ...
    async def test_core_container_dependency_injection(self, core_container):
        ...
        async def dependent_factory() -> DependentServiceImplementation:
            base_service = await core_container.get(TestServiceProtocol)
        ...
        start_time = time.perf_counter()
        dependent_service = await core_container.get(DependentServiceProtocol)
...
class TestContainerOrchestrationRealBehavior:
    ...
    async def test_container_orchestration_performance_metrics(self, di_container):
        ...
        print(f"Batch Service Resolution Performance:")
        ...
        assert batch_resolution_time / service_count < 0.005, f"Average resolution time should be <5ms per service"
        ...
        print(f"Container Performance Metrics:")
...
class TestSpecializedContainerIntegration:
    ...
    async def test_container_system_stress_test(self, test_infrastructure):
        ...
        try:
            ...
            print(f"Service Registration Stress Test:")
            print(f"  Services: {service_count}")
            ...
            print(f"Service Resolution Stress Test:")
            ...
            print(f"Stress Test Summary: PASSED")
