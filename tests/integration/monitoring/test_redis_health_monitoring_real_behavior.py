...
class TestRedisHealthMonitoringRealBehavior:
    ...
    async def test_redis_health_monitoring_basic_operations(self, monitoring_facade, redis_client):
        ...
        assert "redis_primary" in list(monitoring_facade.health_service.get_registered_components())
    ...
    async def test_redis_performance_monitoring_under_load(self, redis_client):
        ...
        concurrent_health_checks = [redis_health_checker.check_health() for i in range(5)]
        ...
        print("Health Checks Under Load:")
        ...
        assert healthy_checks >= 4, "At least 4/5 health checks should succeed under load"
    ...
    async def test_redis_cache_service_health_integration(self, redis_container):
        ...
        try:
            ...
            print("Cache Service Health Integration:")
            ...
            # Performance assertions
            assert successful_ops >= 19, "At least 19/20 cache operations should succeed"
    ...
    async def test_redis_monitoring_system_resilience(self, monitoring_facade, redis_container):
        ...
        try:
            ...
            concurrent_health_tasks = [monitoring_facade.check_component_health(checker.name) for checker in health_checkers]
            ...
            print("Concurrent Health Checks:")
            print(f"  Successful: {successful_checks}")
            print(f"  Failed: {failed_checks}")
            print(f"  Duration: {concurrent_time * 1000:.2f}ms")

            assert successful_checks >= 3, "At least 3 health checks should succeed"
...
class TestRedisMonitoringSystemIntegration:
    ...
    async def test_redis_monitoring_system_performance_benchmarks(self, redis_cluster_setup):
        ...
        try:
            ...
            print("Redis Monitoring System Performance Benchmarks:")
            ...
            print("Concurrent Health Check Benchmark:")
            ...
            assert successful_concurrent >= concurrent_iterations * 0.95, "At least 95% of concurrent checks should succeed"
            ...
            print("Metrics Collection Benchmark:")
    ...
    async def test_redis_monitoring_failure_recovery_scenarios(self, redis_cluster_setup):
        ...
        try:
            ...
            print("Post-Cascade System Health:")
            ...
            print("Post-Recovery System Health:")
            ...
            print("  System Resilience: Maintained")
