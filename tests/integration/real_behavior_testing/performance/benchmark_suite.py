...
class BenchmarkSuite:
    ...
    def __init__(
        ...
        ml_container: Optional[MLTestContainer] = None,
    ...
    async def run_comprehensive_benchmark(self) -> Dict[str, Any]:
        ...
        for section_name, benchmark_method in benchmark_sections:
            ...
            try:
                ...
                logger.error(f"Error in benchmark section {section_name}: {e}")
                continue
    ...
    def generate_performance_report(self, results_data: Dict[str, Any]) -> str:
        ...
        for op in analysis["performance_insights"]["fastest_operations"]:
            report_lines.append(f"  ✓ {op['name']}: {op['duration_ms']:.2f}ms ({op['category']})")
        ...
        for op in analysis["performance_insights"]["slowest_operations"]:
            report_lines.append(f"  ⚠ {op['name']}: {op['duration_ms']:.2f}ms ({op['category']})")
