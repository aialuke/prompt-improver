#!/usr/bin/env python3
"""Integration tests for orchestrator with refactored ML components.

Tests the integration between the ML Pipeline Orchestrator and the new
refactored components (feature extractors, clustering engine, etc.).
"""
...
class TestOrchestratorRefactoredIntegration:
    """Test integration between orchestrator and refactored components."""
    ...
    @pytest.mark.asyncio
    async def test_orchestrator_loads_refactored_context_learner(self, component_loader):
        """Test that orchestrator can load the refactored context learner."""
        # Load refactored context learner through orchestrator
        tier1_key = ComponentTier.TIER_1_CORE
        loaded_component = await component_loader.load_component('context_learner', tier1_key)
    ...
    @pytest.mark.asyncio
    async def test_refactored_context_learner_integration(self, sample_training_data):
        """Test that refactored context learner integrates all components."""
    ...
    async def test_end_to_end_workflow_integration(self, component_loader, sample_training_data):
        ...
        # 1. Load refactored context learner through orchestrator
        tier1_key = ComponentTier.TIER_1_CORE
        loaded_component = await component_loader.load_component('refactored_context_learner', tier1_key)
    ...
    def test_performance_comparison(self):
        ...
        # Test new refactored components
...
if __name__ == "__main__":
    ...
    async def quick_test():
        ...
        test_instance = TestOrchestratorRefactoredIntegration()
        ...
        test_instance.test_refactored_components_available()
        print("✅ Refactored components test passed")
