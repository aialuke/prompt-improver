...
from src.prompt_improver.learning.context_learner import ContextSpecificLearner, ContextConfig
...
class TestContextAwareWeightingIntegration:
        ...
        return [
            {
                ...
                'actionability': 0.8,
                'effectiveness': 0.8,
                'context': {'projectType': 'api', 'domain': 'other', 'complexity': 'high', 'teamSize': 5}
            },
            {
                ...
                'actionability': 0.9,
                'effectiveness': 0.9,
                'context': {'projectType': 'web', 'domain': 'other', 'complexity': 'medium', 'teamSize': 8}
            }
        ]
        ...
        return [
            {
                ...
                'actionability': 0.7,
                'effectiveness': 0.7,
                'context': {'projectType': 'other', 'domain': 'other', 'complexity': 'medium', 'teamSize': 3}
            },
            {
                ...
                'actionability': 0.8,
                'effectiveness': 0.8,
                'context': {'projectType': 'other', 'domain': 'other', 'complexity': 'medium', 'teamSize': 5}
            }
        ]
    ...
    def test_mixed_domain_clustering(self, learner, software_results, creative_results):
        ...
        assert np.max(differences) > 0.1  # Some features should show significant differences
    ...
    def test_confidence_impact(self, learner):
        ...
        high_confidence_result = [{
            ...
            'actionability': 0.8,
            'effectiveness': 0.8,
            'context': {'projectType': 'ml', 'domain': 'other', 'complexity': 'high', 'teamSize': 5}
        }]
        ...
        low_confidence_result = [{
            ...
            'actionability': 0.5,
            'effectiveness': 0.5,
            'context': {'projectType': 'other', 'domain': 'other', 'complexity': 'low', 'teamSize': 3}
        }]
    ...
    def test_weighting_performance(self, learner, software_results):
        ...
        overhead_ratio = weighted_time / max(unweighted_time, 0.001)  # Avoid division by zero
    ...
    def test_hybrid_domain_handling(self, learner):
        ...
        hybrid_results = [{
            ...
            'actionability': 0.8,
            'effectiveness': 0.8,
            'context': {'projectType': 'ml', 'domain': 'other', 'complexity': 'high', 'teamSize': 6}
        }]
    ...
    def test_large_batch_processing(self):
        ...
        for i in range(50):  # 50 results to test scalability
            result = {
                ...
                'actionability': 0.8,
                'effectiveness': 0.7,
                'context': {'projectType': 'api', 'complexity': 'medium', 'teamSize': 5}
            }
        ...
        for batch_num in range(10):
            ...
            for i in range(20):
                result = {
                    ...
                    'actionability': 0.8,
                    'effectiveness': 0.8,
                    'context': {'projectType': 'api', 'complexity': 'high', 'teamSize': 5}
                }
