...
class MockSession:
    ...
    async def execute(self, query, parameters=None):
        ...
        elif "pg_stat_statements" in query_text:
        ...
        elif "pg_extension" in query_text and "pg_stat_statements" in query_text:
        ...
        elif "pg_database_size" in query_text:
            # Mock database size
            return MockResult([(1024*1024*1024,)])  # 1GB
        
        elif "pg_tables" in query_text:
        ...
        elif "pg_stat_database" in query_text:
            # Mock database statistics
            return MockResult([
                (1000, 50, 5000, 45000, 100000, 80000, 500, 200, 100, 0, 5, 1024*1024, 2, datetime.now(UTC))
            ])
        
        elif "pg_settings" in query_text and "shared_buffers" in query_text:
