...
class PerformanceThresholds:
    ...
    full_cache_max_p95_time: float = 0.05
    ...
    min_slo_compliance_rate: float = 0.95
...
class TestScenarios:
    ...
    def get_memory_constrained_config() -> CacheTestConfig:
        ...
        return CacheTestConfig(l1_max_size=10, warming_interval=300, max_warming_keys=5)
    ...
    def get_warming_disabled_config() -> CacheTestConfig:
        ...
        return CacheTestConfig(enable_warming=False)

    @staticmethod
    def get_l2_disabled_config() -> CacheTestConfig:
        """Configuration with L2 cache disabled."""
        return CacheTestConfig(enable_l2=False, enable_warming=False)
