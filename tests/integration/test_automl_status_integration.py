...
async def test_real_behavior_integration():
    ...
    try:
        ...
        test_data = {'status': 'running', 'current_trial': 15, 'total_trials': 50, 'trials_completed': 14, 'trials_failed': 1, 'best_score': 0.892, 'current_objective': 'accuracy', 'optimization_time': 1800, 'best_params': {'learning_rate': 0.01, 'n_estimators': 100, 'max_depth': 6}, 'recent_scores': [0.85, 0.87, 0.89, 0.892, 0.888]}
