...
def e2e_client(docker_compose_setup):
    ...
    class E2EClient:
        ...
        def improve_prompt(self, session_id: str, prompt: str, context: Dict = None):
        ...
        async def mcp_improve_prompt(self, prompt: str, context: Dict = None):
            ...
            try:
                result = await session.call_tool("improve_prompt", {
                    "prompt": prompt,
                    "context": context or {}
                })
                return result
