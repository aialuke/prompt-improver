        ...
        try:
            result = EndToEndRealResult(
                ...
                business_impact_measured={
                    "user_experience_improvement": 0.3,
        ...
        try:
            result = EndToEndRealResult(
                ...
                actual_performance_metrics={
                    ...
                    "model_deployment_speed": 0.75,
                    "experimentation_velocity": 2.0,
                },
                business_impact_measured={
                    "research_productivity": 2.0,
                    "model_quality_improvement": 0.2,
                },
            )
        except Exception as e:
            result = EndToEndRealResult(
