...
class TestEventBus:
    ...
    async def test_subscribe_and_emit(self, event_bus):
        ...
        event = MLEvent(
            ...
            data={"workflow_id": "test-123", "model": "test_model"}
        )
    ...
    async def test_handler_error_handling(self, event_bus):
        ...
        # Working handler should still receive the event despite failing handler
        assert len(events_received) == 1
    ...
    async def test_event_statistics(self, event_bus):
        ...
        # Emit various events
        events_to_emit = [
            MLEvent(EventType.TRAINING_STARTED, "test", {}),
            MLEvent(EventType.TRAINING_COMPLETED, "test", {}),
            MLEvent(EventType.EVALUATION_STARTED, "test", {}),
            MLEvent(EventType.TRAINING_STARTED, "test", {}),  # Duplicate type
        ]
    ...
    async def test_bulk_event_emission(self, event_bus):
        ...
        # Sort both lists since async processing might change order
...
class TestEventSubscription:
    ...
    def test_subscription_creation(self):
        ...
        subscription = EventSubscription(
            ...
            subscriber_info="test_subscriber"
        )
    ...
    def test_subscription_serialization(self):
        ...
        # Convert to dict (excluding handler which isn't serializable)
...
class TestMLEvent:
    ...
    def test_event_metadata(self):
        ...
        event = MLEvent(
            ...
            data={"resource_type": "CPU", "amount": 2.0}
        )
