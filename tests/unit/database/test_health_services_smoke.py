...
class TestBackwardCompatibility:
    ...
    def test_unified_service_has_legacy_methods(self, mock_session_manager):
        ...
        assert callable(getattr(service, 'identify_health_issues'))
        assert callable(getattr(service, 'generate_recommendations'))
    ...
    async def test_unified_service_async_methods(self, mock_session_manager):
        ...
        assert callable(getattr(service, 'collect_comprehensive_metrics'))
        assert callable(getattr(service, 'get_comprehensive_health'))
