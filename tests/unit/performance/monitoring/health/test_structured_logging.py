...
from prompt_improver.performance.monitoring.health.structured_logging import HealthMetricsLogger, LogContext, StructuredLogger, get_metrics_logger, log_health_check
...
class TestStructuredLogger:
    ...
    def test_structured_logger_json_format(self):
        ...
        structured.info('Test message', component='test_component', operation='test_operation', custom_field='custom_value')
        handler.flush()
    ...
    def test_structured_logger_error_with_exception(self):
        ...
        try:
            ...
            structured.error('An error occurred during testing', error=e, context='unit_test')
        handler.flush()
        log_output = log_capture.getvalue().strip()
        log_data = json.loads(log_output)
    ...
    async def test_health_check_decorator_successful_execution(self):
        ...
        class MockHealthChecker:
            ...
            async def check_health(self):
                ...
                return HealthResult(status=HealthStatus.HEALTHY, component='test_component', response_time_ms=50, details={'test': 'data'})
...
class TestHealthMetricsLogger:
    ...
    def test_health_metrics_logger_aggregation(self):
        ...
        test_data = [('HEALTHY', 45.2, {'connections': 10}), ('HEALTHY', 52.1, {'connections': 12}), ('WARNING', 89.5, {'connections': 8}), ('HEALTHY', 41.8, {'connections': 11}), ('FAILED', 150.0, {'connections': 5})]
...
class TestLogContext:
    ...
    def test_log_context_to_dict_filters_none(self):
        ...
        context = LogContext(component='test_component', operation='test_op', health_check_type='availability', correlation_id='12345', trace_id=None, user_id=None)
...
def test_correlation_id_integration():
    ...
    with patch('prompt_improver.performance.monitoring.health.structured_logging.get_correlation_id', return_value=mock_correlation_id):
...
async def test_structured_logging_performance():
    ...
    for i in range(100):
        structured.info('Performance test message %s', i, iteration=i, batch='performance_test', data={'nested': {'value': i * 2}})
