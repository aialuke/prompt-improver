...
class TestEnhancedStopCommand:
    ...
    def mock_training_manager(self):
        ...
        manager.get_active_sessions.return_value = [
            MagicMock(session_id="session_1", total_iterations=10, best_performance={"accuracy": 0.8}),
            MagicMock(session_id="session_2", total_iterations=5, best_performance={"accuracy": 0.7})
        ]
    ...
    async def test_graceful_stop_single_session(
        ...
        # Test the core logic that would be in the enhanced stop command
