...
def profile_logs_function():
    ...
    with tempfile.NamedTemporaryFile(mode='w', suffix='.log', delete=False, encoding='utf-8') as f:
        log_entries = ['2024-01-15 10:00:00 INFO Starting application...', '2024-01-15 10:00:01 DEBUG Database connection established', '2024-01-15 10:00:02 WARNING High memory usage detected: 85%', '2024-01-15 10:00:03 ERROR Failed to process request: timeout', '2024-01-15 10:00:04 INFO Request processed successfully'] * 100
