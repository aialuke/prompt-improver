...
from .protocols import MetricsCollectorProtocol, MonitoringRepositoryProtocol
from .types import MetricPoint, MetricType, MonitoringConfig
    ...
    async def _process_metrics(self, metrics: List[MetricPoint]) -> List[MetricPoint]:
        ...
        for processor in self._metric_processors:
            try:
                ...
                logger.error(f"Metric processor failed: {e}")
