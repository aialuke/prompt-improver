...
from prompt_improver.monitoring.unified.alerting_service import AlertingService
from prompt_improver.monitoring.unified.cache_performance_calculator import (
    CachePerformanceCalculator,
)
from prompt_improver.monitoring.unified.health_reporter_service import (
    HealthReporterService,
)
from prompt_improver.monitoring.unified.metrics_collector_service import (
...
class MonitoringOrchestratorService:
    ...
    async def start_orchestration(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to start monitoring orchestration: {e}")
    ...
    async def stop_orchestration(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Error during orchestration shutdown: {e}")
    ...
    async def _start_services(self) -> None:
        ...
        for service_name, start_coro in services:
            try:
                ...
                logger.exception(f"Failed to start {service_name} service: {e}")
    ...
    async def _main_orchestration_loop(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Main orchestration loop failed: {e}")
    ...
    async def _service_health_monitoring_loop(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Service health monitoring loop failed: {e}")
    ...
    async def _cross_service_coordination_loop(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Cross-service coordination loop failed: {e}")
    ...
    async def _check_service_health(self) -> None:
        ...
        for service_name, health_check in services_to_check:
            try:
                ...
                logger.exception(f"Failed to check health of {service_name}: {e}")
                self._service_status[service_name] = False
    ...
    async def _analyze_cross_service_patterns(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to analyze cross-service patterns: {e}")
    ...
    async def _coordinate_resource_usage(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to coordinate resource usage: {e}")
    ...
    async def _synchronize_cache_and_health(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to synchronize cache and health: {e}")
    ...
    async def _share_performance_insights(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to share performance insights: {e}")
    ...
    async def _stop_services(self) -> None:
        ...
        for service_name, stop_coro in services:
            try:
                ...
                logger.exception(f"Failed to stop {service_name} service: {e}")
    ...
    async def get_comprehensive_status(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to get comprehensive status: {e}")
            return {
                "error": str(e),
                "timestamp": datetime.now(UTC).isoformat(),
            }
