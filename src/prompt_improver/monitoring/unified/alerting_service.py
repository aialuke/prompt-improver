...
from .protocols import AlertingServiceProtocol, MonitoringRepositoryProtocol
...
class AlertingService:
    ...
    def __init__(
        ...
        self.monitor_task_id: Optional[str] = None
        ...
        self._last_storm_time: Optional[datetime] = None
