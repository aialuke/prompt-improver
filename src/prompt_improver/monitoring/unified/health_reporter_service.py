...
class HealthReporterService:
    ...
    async def generate_comprehensive_health_report(
        ...
        try:
            ...
            logger.exception(f"Failed to generate comprehensive health report: {e}")
            return {
                "error": str(e),
                "generated_at": datetime.now(UTC).isoformat(),
    ...
    async def generate_component_health_report(
        ...
        try:
            ...
            logger.exception(f"Failed to generate component health report for {component_name}: {e}")
            return {
                "component_name": component_name,
                "error": str(e),
                "generated_at": datetime.now(UTC).isoformat(),
    ...
    async def generate_health_trends_report(self, hours: int = 24) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to generate health trends report: {e}")
            return {
                "error": str(e),
                "generated_at": datetime.now(UTC).isoformat(),
    ...
    async def _get_current_health_status(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to get current health status: {e}")
            return {"error": str(e)}

    async def _get_component_status(self, component_name: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            logger.exception(f"Failed to get component status for {component_name}: {e}")
            return None
    ...
    async def _get_health_history_summary(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to get health history summary: {e}")
            return {"error": str(e)}
    ...
    async def _generate_health_trends(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Failed to generate health trends: {e}")
            return {"error": str(e)}
    ...
    async def _generate_health_recommendations(self, current_health: dict[str, Any]) -> list[str]:
        ...
        try:
            ...
            logger.exception(f"Failed to generate health recommendations: {e}")
    ...
    async def _get_component_status_breakdown(self) -> dict[str, int]:
        ...
        try:
            ...
            logger.exception(f"Failed to get component status breakdown: {e}")
            return {"error": 1}
    ...
    async def format_report(self, report: dict[str, Any], format_name: str) -> Any:
        ...
        try:
            ...
            logger.exception(f"Custom formatter {format_name} failed: {e}")
            return report
