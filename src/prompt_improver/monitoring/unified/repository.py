...
from .protocols import MonitoringRepositoryProtocol
from .types import HealthCheckResult, MetricPoint
...
class MonitoringRepository:
    ...
    def __init__(self, manager_mode: ManagerMode = ManagerMode.HIGH_AVAILABILITY):
    ...
    async def store_health_result(self, result: HealthCheckResult) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to store health result for {result.component_name}: {e}")
            raise
    ...
    async def get_health_history(
        ...
        try:
            ...
            logger.error(f"Failed to get health history for {component_name}: {e}")
    ...
    def _dict_to_health_result(self, data: Dict[str, Any]) -> HealthCheckResult:
        ...
        from .types import HealthStatus, ComponentCategory
