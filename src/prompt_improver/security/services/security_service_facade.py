...
from prompt_improver.core.protocols.security_service.security_protocols import (
...
class SecurityServiceFacade:
    ...
    def __init__(
        self,
        authentication_service: Optional[AuthenticationServiceProtocol] = None,
        authorization_service: Optional[AuthorizationServiceProtocol] = None,
        validation_service: Optional[ValidationServiceProtocol] = None,
        monitoring_service: Optional[SecurityMonitoringServiceProtocol] = None,
    ):
