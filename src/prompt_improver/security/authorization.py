...
class AuthorizationService:
    ...
    def __init__(self):
        self.role_permissions: dict[Role, set[Permission]] = {Role.user: {Permission.READ_MODELS, Permission.VIEW_USERS}, Role.ML_ENGINEER: {Permission.READ_MODELS, Permission.WRITE_MODELS, Permission.RUN_ADVERSARIAL_TESTS, Permission.VIEW_USERS}, Role.PRIVACY_OFFICER: {Permission.READ_MODELS, Permission.ACCESS_DIFFERENTIAL_PRIVACY, Permission.CONFIGURE_PRIVACY_BUDGET, Permission.VIEW_AUDIT_LOGS, Permission.VIEW_USERS}, Role.SECURITY_ADMIN: {Permission.READ_MODELS, Permission.WRITE_MODELS, Permission.RUN_ADVERSARIAL_TESTS, Permission.CONFIGURE_SECURITY, Permission.VIEW_AUDIT_LOGS, Permission.VIEW_USERS, Permission.MANAGE_USERS}, Role.admin: set(Permission)}
    ...
    def can_access_resource(self, user_id: str, resource_type: str, action: str) -> bool:
        """Check if user can perform action on resource type."""
        permission_map = {('models', 'read'): Permission.READ_MODELS, ('models', 'write'): Permission.WRITE_MODELS, ('models', 'delete'): Permission.DELETE_MODELS, ('users', 'read'): Permission.VIEW_USERS, ('users', 'write'): Permission.MANAGE_USERS, ('users', 'delete'): Permission.MANAGE_USERS, ('privacy', 'access'): Permission.ACCESS_DIFFERENTIAL_PRIVACY, ('privacy', 'configure'): Permission.CONFIGURE_PRIVACY_BUDGET, ('security', 'test'): Permission.RUN_ADVERSARIAL_TESTS, ('security', 'configure'): Permission.CONFIGURE_SECURITY, ('audit', 'view'): Permission.VIEW_AUDIT_LOGS, ('system', 'admin'): Permission.ADMIN_SYSTEM}
    ...
    def get_accessible_resources(self, user_id: str) -> dict[str, list[str]]:
        ...
        accessible = {}
        permission_to_resource = {Permission.READ_MODELS: ('models', 'read'), Permission.WRITE_MODELS: ('models', 'write'), Permission.DELETE_MODELS: ('models', 'delete'), Permission.VIEW_USERS: ('users', 'read'), Permission.MANAGE_USERS: ('users', 'write'), Permission.ACCESS_DIFFERENTIAL_PRIVACY: ('privacy', 'access'), Permission.CONFIGURE_PRIVACY_BUDGET: ('privacy', 'configure'), Permission.RUN_ADVERSARIAL_TESTS: ('security', 'test'), Permission.CONFIGURE_SECURITY: ('security', 'configure'), Permission.VIEW_AUDIT_LOGS: ('audit', 'view'), Permission.ADMIN_SYSTEM: ('system', 'admin')}
