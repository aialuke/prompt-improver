...
class SecureLogger:
    ...
    def log_error_safely(self, level: str, operation: str, error: Exception, 
                        include_type: bool = True, extra_context: Optional[str] = None):
    ...
    def warning(self, operation: str, error: Exception, **kwargs):
        """Log error at WARNING level."""
        self.log_error_safely("warning", operation, error, **kwargs)
    
    def info(self, operation: str, error: Exception, **kwargs):
    ...
    def log_performance_metric(self, operation: str, metrics: dict):
