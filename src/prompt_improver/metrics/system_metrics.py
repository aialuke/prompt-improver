        ...
        try:
            with self._connection_lock:
                if connection_id in self._connections:
                    self._connections[connection_id].last_used = datetime.now(UTC)
    ...
    def _record_cache_operation(self, cache_type: str, cache_name: str, operation: str,
        ...
        try:
            ...
            with self._cache_lock:
                ...
                window_age = (datetime.now(UTC) - self._window_start[cache_key]).total_seconds()
    ...
    def get_cache_statistics(self, cache_type: str, cache_name: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "window_age_minutes": (datetime.now(UTC) - self._window_start[cache_key]).total_seconds() / 60
            }
...
class FeatureUsageAnalytics:
    ...
    def _update_feature_metrics(self, feature_type: str, feature_name: str, feature_key: str) -> None:
        ...
        try:
            ...
            window_start = datetime.now(UTC) - timedelta(hours=self.config.feature_usage_window_hours)
