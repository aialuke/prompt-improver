...
from .enhanced_quality_scorer import EnhancedQualityScorer, EnhancedQualityMetrics
...
class ProductionSyntheticDataGenerator:
    ...
    def __init__(self, target_samples: int = 1000, random_state: int = 42, use_enhanced_scoring: bool = True):
    ...
    def _initialize_domain_configs(self) -> Dict[str, DomainConfig]:
        ...
        return {
            "technical": DomainConfig(
                ...
                patterns=[
                    ("Create API endpoint", "Create a comprehensive REST API endpoint with authentication, rate limiting, error handling, and detailed OpenAPI documentation including examples"),
                    ("Debug error", "Debug this specific error by analyzing logs, identifying root cause, implementing robust error handling, and adding prevention measures"),
                    ("Optimize function", "Optimize this function for performance by implementing algorithmic improvements, memory efficiency, and scalability considerations"),
                    ("Add tests", "Add comprehensive unit tests with edge cases, mocking strategies, integration test coverage, and performance benchmarks"),
                    ("Document system", "Document this system architecture with detailed diagrams, deployment guides, troubleshooting procedures, and maintenance workflows"),
                    ("Setup guide", "Create a detailed setup guide with prerequisites, step-by-step instructions, verification steps, and common troubleshooting solutions"),
                    ("Code review", "Conduct thorough code review focusing on security, performance, maintainability, and adherence to best practices"),
                    ("Refactor code", "Refactor this code to improve readability, reduce complexity, eliminate duplication, and enhance testability"),
                ],
                feature_ranges={
            ...
            "creative": DomainConfig(
                ...
                patterns=[
                    ("Write story", "Write an engaging story with compelling characters, clear narrative arc, vivid descriptive details, and emotional resonance"),
                    ("Create content", "Create engaging content that resonates with the target audience, drives meaningful engagement, and achieves specific goals"),
                    ("Improve writing", "Improve this writing by enhancing flow, adding sensory details, strengthening emotional impact, and clarifying messaging"),
                    ("Add creativity", "Add creative elements like metaphors, unique perspectives, innovative approaches, and memorable hooks"),
                    ("Write copy", "Write persuasive copy that speaks to customer pain points, highlights unique value propositions, and drives action"),
                    ("Create campaign", "Create a comprehensive marketing campaign with compelling messaging, multi-channel strategy, and measurable success metrics"),
                    ("Design content", "Design visual content that captures attention, communicates key messages, and aligns with brand identity"),
                    ("Brand voice", "Develop a distinctive brand voice that reflects company values, resonates with target audience, and maintains consistency"),
                ],
                feature_ranges={
                ...
                effectiveness_params=(2, 2),  # Beta(2,2) - more uniform for subjective creative quality
            ...
            "analytical": DomainConfig(
                ...
                patterns=[
                    ("Analyze data", "Analyze this dataset comprehensively including statistical summaries, trend identification, correlation analysis, and actionable insights"),
                    ("Research topic", "Research this topic thoroughly using reliable sources, synthesizing findings, identifying patterns, and drawing evidence-based conclusions"),
                    ("Create report", "Create a detailed analytical report with executive summary, methodology, key findings, recommendations, and supporting visualizations"),
                    ("Compare options", "Compare these options systematically using relevant criteria, quantitative analysis, risk assessment, and strategic recommendations"),
                    ("Identify trends", "Identify significant trends in this data using statistical analysis, predictive modeling, and contextual interpretation"),
                    ("Validate hypothesis", "Validate this hypothesis through rigorous testing, statistical analysis, and comprehensive evaluation of evidence"),
                    ("Performance metrics", "Establish comprehensive performance metrics with baselines, targets, measurement methods, and reporting frameworks"),
                    ("Market analysis", "Conduct thorough market analysis including competitor research, trend analysis, opportunity identification, and strategic implications"),
                ],
                feature_ranges={
            ...
            "instructional": DomainConfig(
                ...
                patterns=[
                    ("Explain concept", "Explain this concept clearly with simple language, relevant examples, step-by-step breakdowns, and practical applications"),
                    ("Create tutorial", "Create a comprehensive tutorial with learning objectives, structured lessons, hands-on exercises, and progress assessments"),
                    ("Teaching guide", "Develop a teaching guide with curriculum outline, learning activities, assessment methods, and differentiation strategies"),
                    ("Simplify complex", "Simplify this complex topic using analogies, visual aids, progressive disclosure, and relatable examples"),
                    ("Learning path", "Design a learning path with prerequisites, milestones, resources, practice opportunities, and mastery indicators"),
                    ("Study guide", "Create a study guide with key concepts, practice questions, review activities, and self-assessment tools"),
                    ("Workshop design", "Design an interactive workshop with clear objectives, engaging activities, collaborative exercises, and practical outcomes"),
                    ("Skill development", "Develop a skill-building program with competency frameworks, practice scenarios, feedback mechanisms, and certification criteria"),
                ],
                feature_ranges={
            ...
            "conversational": DomainConfig(
                ...
                patterns=[
                    ("Answer question", "Answer this question thoroughly with clear explanations, relevant context, helpful examples, and follow-up guidance"),
                    ("Provide advice", "Provide thoughtful advice considering multiple perspectives, potential outcomes, practical steps, and personalized recommendations"),
                    ("Clarify confusion", "Clarify this confusion by addressing misconceptions, providing clear explanations, and offering additional resources"),
                    ("Support request", "Respond to this support request with empathy, practical solutions, step-by-step guidance, and follow-up options"),
                    ("Facilitate discussion", "Facilitate this discussion by asking thoughtful questions, encouraging participation, and synthesizing key points"),
                    ("Resolve conflict", "Help resolve this conflict through active listening, perspective-taking, common ground identification, and solution-focused approaches"),
                    ("Build rapport", "Build rapport through authentic engagement, shared understanding, emotional intelligence, and mutual respect"),
                    ("Guide decision", "Guide this decision-making process with structured analysis, option evaluation, and personalized recommendations"),
                ],
                feature_ranges={
                    ...
                    "actionability": (0.4, 0.8) # Variable actionability for conversation
                },
                effectiveness_params=(2, 2.5), # Beta(2,2.5) - slightly skewed for helpful responses
    ...
    async def generate_comprehensive_training_data(self) -> Dict[str, Any]:
        ...
        logger.info(f"Starting generation of {self.target_samples} high-quality synthetic samples")
        ...
        for domain_name, domain_config in self.domains.items():
            ...
            domain_data = await self._generate_domain_data(domain_config, domain_samples)
        ...
        features, effectiveness = self._ensure_quality_guarantees(all_features, all_effectiveness)
        ...
        if self.use_enhanced_scoring:
            ...
            enhanced_metrics = await self.quality_scorer.assess_comprehensive_quality(
                ...
                {"target_samples": self.target_samples, "random_state": self.random_state}
            )
            
            # Apply corrections if overall score is below threshold
            if enhanced_metrics.overall_score < 0.55:  # ADEQUATE threshold
                logger.warning(f"Enhanced quality score {enhanced_metrics.overall_score:.3f} below threshold, applying corrections")
                features, effectiveness = self._apply_quality_corrections(features, effectiveness)
            ...
            legacy_metrics = self._validate_ml_requirements(features, effectiveness, domain_counts)
            
            if not legacy_metrics.overall_quality:
                logger.warning("Generated data failed quality validation, applying corrections")
                features, effectiveness = self._apply_quality_corrections(features, effectiveness)
                legacy_metrics = self._validate_ml_requirements(features, effectiveness, domain_counts)
        ...
        result = {
            ...
            "prompts": all_prompts[:len(features)],  # Ensure alignment after corrections
            "metadata": {
        ...
        logger.info(f"Successfully generated {len(features)} high-quality synthetic samples")
        return result
    
    async def _generate_domain_data(self, domain_config: DomainConfig, sample_count: int) -> Dict[str, Any]:
    ...
    def _transform_to_domain_features(self, base_features: np.ndarray, domain_config: DomainConfig) -> List[float]:
        """Transform normalized features to domain-specific ranges"""
        
        # Normalize base features to [0, 1] range
        normalized_features = (base_features - base_features.min()) / (base_features.max() - base_features.min() + 1e-8)
        ...
        for i, feature_name in enumerate(self.feature_names):
            ...
            if feature_name == "complexity":
                ...
                complexity_val = int(
                    feature_range[0] + normalized_features[i] * (feature_range[1] - feature_range[0])
                )
    ...
    def _generate_domain_effectiveness(self, domain_config: DomainConfig, base_class: int) -> float:
    ...
    def _ensure_quality_guarantees(self, features: List[List[float]], effectiveness: List[float]) -> Tuple[List[List[float]], List[float]]:
        ...
        if effectiveness_std < self.quality_thresholds["min_variance"]:
            logger.warning(f"Low variance ({effectiveness_std:.3f}), injecting controlled noise")
        ...
        if max_corr > self.quality_thresholds["max_correlation"]:
            logger.warning(f"High feature correlation ({max_corr:.3f}), applying decorrelation")
    ...
    def _apply_three_tier_distribution(self, effectiveness_array: np.ndarray) -> np.ndarray:
        ...
        # High performers (25%)
        effectiveness_array[shuffle_indices[:quarter_size]] = self.rng.uniform(0.7, 1.0, quarter_size)
        
        # Medium performers (50%)
        effectiveness_array[shuffle_indices[quarter_size:quarter_size + half_size]] = self.rng.uniform(0.4, 0.6, half_size)
        
        # Low performers (25%)
        effectiveness_array[shuffle_indices[quarter_size + half_size:]] = self.rng.uniform(0.0, 0.3, n_samples - quarter_size - half_size)
    ...
    def _validate_ml_requirements(self, features: List[List[float]], effectiveness: List[float], domain_counts: Dict[str, int]) -> QualityMetrics:
        ...
        variance_sufficient = np.std(effectiveness_array) >= self.quality_thresholds["min_variance"]
        ...
        no_invalid_values = not (np.isnan(features_array).any() or np.isnan(effectiveness_array).any())
        ...
        feature_correlations = {
            ...
            "mean_correlation": float(np.mean(np.abs(correlations[np.triu_indices_from(correlations, k=1)]))),
            "correlation_threshold_met": max_corr <= self.quality_thresholds["max_correlation"]
        }
    ...
    def _apply_quality_corrections(self, features: List[List[float]], effectiveness: List[float]) -> Tuple[List[List[float]], List[float]]:
        ...
        while len(features) < self.quality_thresholds["min_samples"]:
            ...
            new_feature = np.array(features[idx]) + self.rng.normal(0, 0.05, len(features[idx]))
        ...
        features, effectiveness = self._ensure_quality_guarantees(features, effectiveness_array.tolist())
        
        return features, effectiveness
    
    async def save_to_database(self, training_data: Dict[str, Any], db_session: AsyncSession) -> int:
        ...
        try:
            for i, (feature_vector, effectiveness, (original, enhanced)) in enumerate(
                zip(features, effectiveness_scores, prompts)
            ):
                ...
                training_prompt = TrainingPrompt(
                    ...
                    enhancement_result={
                        ...
                        "metadata": {
                            ...
                            "domain": self._identify_domain_from_index(i, metadata["domain_distribution"]),
            ...
            logger.info(f"Successfully saved {saved_count} synthetic training samples to database")
    ...
    def _identify_domain_from_index(self, index: int, domain_distribution: Dict[str, int]) -> str:
    ...
    def get_generation_summary(self, training_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.use_enhanced_scoring and "enhanced_quality_metrics" in metadata:
            ...
            quality_report = self.quality_scorer.generate_quality_report(enhanced_metrics)
            
            return {
                "generation_summary": {
                    "total_samples": metadata["total_samples"],
                    "target_samples": self.target_samples,
                    "generation_efficiency": metadata["total_samples"] / self.target_samples,
    ...
    def _generate_recommendations(self, quality_metrics: QualityMetrics) -> List[str]:
        ...
        if not quality_metrics.overall_quality:
            recommendations.append("Consider increasing sample count for more robust ML training")
        
        if quality_metrics.class_diversity < 3:
            recommendations.append("Enhance effectiveness score stratification for better class separation")
        
        if not quality_metrics.variance_sufficient:
            recommendations.append("Increase diversity in generation patterns to improve variance")
        
        if quality_metrics.feature_correlations["max_correlation"] > 0.7:
            recommendations.append("Reduce feature correlations for improved ML model performance")
        
        if quality_metrics.overall_quality:
            recommendations.append("Generated data meets all quality requirements for ML training")
