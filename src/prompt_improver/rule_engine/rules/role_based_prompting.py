...
EXPERTISE_LEVELS = {
    'junior': {
        ...
        'characteristics': ['eager to learn', 'follows established patterns', 'seeks guidance'],
        'tone': 'enthusiastic and learning-oriented'
    },
    'mid_level': {
        'experience': '3-7 years',
        'characteristics': ['solid foundation', 'practical experience', 'problem-solving focus'],
        'tone': 'confident and practical'
    },
    'senior_level': {
        'experience': '7-15 years',
        'characteristics': ['deep expertise', 'strategic thinking', 'mentorship capability'],
        'tone': 'authoritative and insightful'
    },
    'expert': {
        'experience': '15+ years',
        'characteristics': ['industry leader', 'innovative thinking', 'comprehensive knowledge'],
...
class RoleBasedPromptingRule(BasePromptRule):
    ...
    def check(self, prompt: str, context=None) -> RuleCheckResult:
        ...
        applies = (
            role_metrics['domain'] != 'general' and
            not role_metrics['already_has_role'] and
            role_metrics['benefits_from_expertise']
        )
...
"""
    ...
    def _analyze_role_requirements(self, prompt: str) -> Dict[str, Any]:
        ...
        role_indicators = [
            'you are', 'act as', 'as a', 'as an', 'role of', 'perspective of',
        ...
        expertise_beneficial_domains = [
            'technical', 'business', 'academic', 'legal', 'medical', 
            'financial', 'scientific', 'creative'
        ]
    ...
    def _assess_task_complexity(self, prompt: str) -> float:
        ...
        complex_indicators = [
            ...
            'strategic', 'innovative', 'optimize', 'analyze', 'evaluate',
            'design', 'implement', 'develop', 'create', 'solve'
        ]
        ...
        scope_indicators = [
            'system', 'framework', 'architecture', 'strategy', 'methodology',
            'process', 'workflow', 'integration', 'scalable', 'enterprise'
        ]
