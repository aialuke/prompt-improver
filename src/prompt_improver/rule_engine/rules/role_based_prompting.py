...
DOMAIN_PATTERNS = {
    "technical": [
        "\\b(code|coding|programming|software|algorithm|system|API|framework|database)\\b",
        "\\b(technical|technology|engineering|development|architecture)\\b",
        "\\b(debug|optimize|implement|deploy|configure)\\b",
    ],
    "business": [
        "\\b(business|marketing|sales|finance|revenue|profit|strategy|market)\\b",
        "\\b(customer|client|stakeholder|investor|budget|ROI)\\b",
        "\\b(corporate|company|organization|enterprise)\\b",
    ],
    "academic": [
        "\\b(research|study|academic|scholarly|paper|thesis|methodology)\\b",
        "\\b(hypothesis|analysis|findings|conclusion|literature|peer)\\b",
        "\\b(university|professor|student|curriculum)\\b",
    ],
    "creative": [
        "\\b(creative|story|narrative|poem|art|design|writing|content)\\b",
        "\\b(imagination|inspiration|artistic|aesthetic|style)\\b",
        "\\b(author|writer|artist|designer|creator)\\b",
    ],
    "legal": [
        "\\b(legal|law|contract|regulation|compliance|policy|statute)\\b",
        "\\b(attorney|lawyer|counsel|court|judge|litigation)\\b",
        "\\b(rights|obligations|liability|jurisdiction)\\b",
    ],
    "medical": [
        "\\b(medical|health|patient|diagnosis|treatment|clinical|therapeutic)\\b",
        "\\b(doctor|physician|nurse|healthcare|hospital|clinic)\\b",
        "\\b(symptoms|medicine|therapy|surgical|pharmaceutical)\\b",
    ],
    "education": [
        "\\b(teach|learn|education|training|course|curriculum|instruction)\\b",
        "\\b(teacher|instructor|student|learner|pedagogy)\\b",
        "\\b(classroom|lesson|assessment|evaluation)\\b",
    ],
    "financial": [
        "\\b(financial|investment|banking|accounting|audit|tax)\\b",
        "\\b(money|capital|assets|portfolio|risk|returns)\\b",
        "\\b(analyst|advisor|accountant|banker)\\b",
    ],
    "scientific": [
        "\\b(scientific|science|experiment|research|hypothesis|theory)\\b",
        "\\b(data|analysis|methodology|results|conclusion)\\b",
        "\\b(scientist|researcher|laboratory|study)\\b",
    ],
}
EXPERTISE_LEVELS = {
    "junior": {
