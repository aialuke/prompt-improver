...
QUALITY_INDICATORS = [
    'clear_format', 'diverse_content', 'appropriate_length',
    'relevant_domain', 'balanced_examples', 'progressive_difficulty'
]
...
class FewShotExampleRule(BasePromptRule):
    ...
    def check(self, prompt: str, context=None) -> RuleCheckResult:
        ...
        applies = (
            example_metrics['task_benefits_from_examples'] and
            not example_metrics['already_has_examples'] and
            example_metrics['task_complexity'] > 0.3
        )
        ...
        return RuleCheckResult(
            ...
            metadata={
                ...
                "task_benefits_from_examples": example_metrics['task_benefits_from_examples'],
                "already_has_examples": example_metrics['already_has_examples'],
                "recommended_example_count": example_metrics['recommended_example_count'],
...
"""
    ...
    def _analyze_example_requirements(self, prompt: str) -> Dict[str, Any]:
        ...
        complexity_indicators = len([word for word in words if word in [
            'complex', 'detailed', 'comprehensive', 'specific', 'nuanced',
            'sophisticated', 'advanced', 'technical', 'specialized'
        ]])
    ...
    def _identify_domain(self, prompt: str) -> str:
        ...
        domain_keywords = {
            'business': ['business', 'marketing', 'sales', 'finance', 'corporate', 'company'],
            'technical': ['code', 'programming', 'software', 'algorithm', 'technical', 'system'],
            'academic': ['research', 'study', 'academic', 'scholarly', 'paper', 'thesis'],
            'creative': ['creative', 'story', 'poem', 'art', 'design', 'writing'],
            'legal': ['legal', 'law', 'contract', 'regulation', 'compliance', 'policy'],
            'medical': ['medical', 'health', 'patient', 'diagnosis', 'treatment', 'clinical'],
            'education': ['teach', 'learn', 'student', 'education', 'training', 'course']
        }
    ...
    def _customize_for_domain(self, templates: List[Dict[str, str]], domain: str) -> List[Dict[str, str]]:
        ...
        domain_customizations = {
            ...
            'academic': {
                'keywords': ['research', 'hypothesis', 'methodology', 'analysis', 'findings'],
