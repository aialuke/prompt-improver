...
COMPLEXITY_INDICATORS = [
    ...
    'comprehensive', 'thorough', 'step-by-step', 'structured', 'organized'
]

# Content type patterns for automatic tagging
CONTENT_PATTERNS = {
    'context': [
        r'given that', r'in the context of', r'background', r'situation',
        r'considering', r'based on', r'scenario', r'setting'
    ],
    'instruction': [
        r'please', r'can you', r'I need', r'help me', r'create', r'write',
        r'generate', r'analyze', r'evaluate', r'explain', r'describe'
    ],
    'examples': [
        r'for example', r'such as', r'like', r'including', r'e\.g\.',
        r'instance', r'sample', r'illustration'
    ],
    'constraints': [
        r'must', r'should', r'cannot', r'do not', r'avoid', r'ensure',
        r'requirement', r'constraint', r'limitation', r'restriction'
    ],
    'format': [
        r'format', r'structure', r'organize', r'layout', r'arrange',
        r'present as', r'output as', r'in the form of'
    ]
}
...
class XMLStructureRule(BasePromptRule):
    ...
    def check(self, prompt: str, context=None) -> RuleCheckResult:
        ...
        applies = (
            structure_metrics['complexity_score'] > 0.4 and
            not structure_metrics['already_has_xml'] and
            structure_metrics['benefits_from_structure'] and
            structure_metrics['word_count'] > 20
        )
