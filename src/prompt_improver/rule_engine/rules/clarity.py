...
VAGUE_WORDS = [
    "thing", "stuff", "it", "this", "that", "they", "something", "anything",
    "better", "good", "nice", "bad", "awesome", "great", "fine", "okay",
    "analyze", "summarize", "improve", "enhance", "optimize", "fix",
    "some", "many", "few", "several", "various", "different", "certain",
    "appropriate", "suitable", "relevant", "important", "significant"
]

# Hedge words that reduce specificity
HEDGE_WORDS = [
    "perhaps", "maybe", "might", "could", "should", "probably", "possibly",
    ...
    def _enhance_specificity(self, prompt: str) -> tuple[str, List[Dict]]:
        ...
        for vague, specific in vague_quantifiers.items():
            if vague in enhanced_prompt.lower():
                enhanced_prompt = re.sub(r'\b' + vague + r'\b', specific, enhanced_prompt, flags=re.IGNORECASE)
                improvements.append({
