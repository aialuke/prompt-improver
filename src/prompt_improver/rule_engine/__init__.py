...
class RuleEngine:
    ...
    def apply_rules(self, prompt: str, context: Optional[Dict[str, Any]] = None) -> RuleEngineResult:
        """
...
__all__ = ['RuleEngine', 'RuleEngineResult', 'AppliedRuleResult', 'ClarityRule', 'SpecificityRule']