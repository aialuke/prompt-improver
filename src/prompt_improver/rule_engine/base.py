...
class BasePromptRule(ABC):
    ...
    """
    metadata: dict[str, Any] = {'name': 'Base Rule', 'description': 'This is a base rule and should not be used directly.', 'priority': 'low', 'version': '0.0.0', 'category': 'core'}
    ...
    @abstractmethod
    def apply(self, prompt: str, context: dict[str, Any] | None=None) -> TransformationResult:
