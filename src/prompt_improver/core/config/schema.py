...
class UnifiedConfigService:
    """Unified Configuration Service - Complete Configuration and Feature Flag Management.
    ...
    def _init_feature_flags_manager(self, config_path: str | Path):
        ...
        try:
            ...
            self._feature_flags_manager = FeatureFlagService(config_path)
        except ImportError:
            logger.warning(
                "FeatureFlagService not available - feature flag functionality disabled"
            )
