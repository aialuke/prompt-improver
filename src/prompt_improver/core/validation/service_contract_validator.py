...
from typing import Any, Dict, List, Optional, Protocol, Set, Type, get_origin, get_args
            ...
            if isinstance(node, ast.FunctionDef) and node.name == "__init__":
                ...
                if (parent_class and 
                    ...
                    self.violations.append(ContractViolation(
                        ...
                        file_path=str(file_path),
                        line_number=node.lineno,
                        description=f"Constructor should use protocol-based dependency injection",
                        severity="medium",
