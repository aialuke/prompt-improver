...
from typing import Any, Dict, List, Optional, Protocol, Type, TypeVar, get_origin, get_args
...
class ServiceContract:
    ...
    implementation_factory: Optional[Any]
...
class ProtocolRegistry:
    ...
    def register_contract(
        ...
        implementation_factory: Optional[Any] = None,
        dependencies: Optional[List[Type[Protocol]]] = None,
    ...
    def validate_contract(
        ...
        try:
            ...
            if hasattr(protocol_type, '__annotations__'):
                for attr_name, attr_type in protocol_type.__annotations__.items():
                    if not hasattr(implementation_type, attr_name):
                        warnings.append(f"Missing attribute: {attr_name}")
    ...
    def get_contract(self, protocol_type: Type[P]) -> Optional[ServiceContract]:
        """Get service contract for a protocol."""
        return self._contracts.get(protocol_type)
    
    def get_implementation_type(self, protocol_type: Type[P]) -> Optional[Type]:
    ...
    def generate_dependency_order(self) -> List[Type[Protocol]]:
        ...
        def visit(protocol: Type[Protocol]):
...
def register_protocol_contract(
    protocol_type: Type[P],
    implementation_type: Type[T],
    implementation_factory: Optional[Any] = None,
    dependencies: Optional[List[Type[Protocol]]] = None,
