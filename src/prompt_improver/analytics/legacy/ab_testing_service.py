...
from prompt_improver.common.exceptions import DatabaseError, DataError
        ...
        try:
            ...
            if not experiment:
                raise DataError(
                    ...
                    data_source="stop_experiment",
                    validation_failures=[f"experiment_not_found: {experiment_id}"]
                )
