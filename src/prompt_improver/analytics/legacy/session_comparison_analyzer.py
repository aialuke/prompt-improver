...
from ...common.exceptions import ValidationError, DataError, InternalError
        ...
        try:
            ...
            if not session_a_data or not session_b_data:
                raise DataError(
                    ...
                    data_source='session_comparison_analyzer',
                    validation_failures=['missing_session_data']
                )
        ...
        try:
            ...
            if len(sessions_data) < 2:
                raise ValidationError(
                    'Need at least 2 sessions for multi-session analysis',
                    field='session_count',
                    value=str(len(sessions_data)),
                    validation_rule='minimum_sessions_required',
                    expected_type='integer >= 2'
                )
            session_features = {}
        ...
        try:
            ...
            if method == ComparisonMethod.T_TEST:
                ...
                raise ValidationError(
                    ...
                    value=str(method),
                    validation_rule='supported_comparison_methods',
                    expected_type='ComparisonMethod enum value'
                )
        except Exception as e:
