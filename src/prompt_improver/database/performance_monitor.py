...
class DatabasePerformanceMonitor:
    ...
    async def get_slow_queries(self, min_calls: int = 10) -> List[QueryPerformanceMetric]:
        ...
        if has_extension:
            ...
            return [QueryPerformanceMetric(
                ...
                total_exec_time=client_stats['avg_query_time_ms'] * client_stats['total_queries'],
    ...
    async def take_performance_snapshot(self) -> DatabasePerformanceSnapshot:
        ...
        cache_hit_ratio, index_hit_ratio, active_connections, database_size, slow_queries = await asyncio.gather(
    ...
    async def get_performance_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        return {
            ...
            "performance_status": "GOOD" if avg_cache_hit >= 90 and avg_query_time <= 50 else "NEEDS_ATTENTION",
            "target_compliance": {
