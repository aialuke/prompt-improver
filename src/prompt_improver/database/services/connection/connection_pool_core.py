...
class ConnectionPoolCore:
    ...
    async def initialize(self) -> bool:
        ...
        async with self.context.initialization_lock:
            ...
            try:
                ...
                logger.error(f"Failed to initialize ConnectionPoolCore: {e}")
                raise
    ...
    async def get_session(
        ...
        try:
            ...
            logger.error(f"Session error in {self.context.service_name}: {e}")
            raise
        finally:
            await session.close()
    ...
    async def shutdown(self) -> None:
        ...
        try:
            ...
            logger.error(f"Error during ConnectionPoolCore shutdown: {e}")
