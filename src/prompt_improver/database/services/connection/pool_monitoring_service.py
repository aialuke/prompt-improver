...
class PoolMonitoringService:
    ...
    def __init__(
        ...
        scaling_manager: PoolScalingManagerProtocol | None = None,
    ) -> None:
    ...
    async def start_monitoring(self) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to start background monitoring: {e}")
            raise
    ...
    async def _metrics_update_loop(self) -> None:
        ...
        while self.context.is_initialized:
            try:
                ...
                logger.exception(f"Metrics update error: {e}")
                await asyncio.sleep(self._metrics_update_interval)
