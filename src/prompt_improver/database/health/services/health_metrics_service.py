...
from .health_protocols import HealthMetricsServiceProtocol
from .health_types import QueryPerformanceMetrics
...
class HealthMetricsService:
    ...
    async def collect_lock_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Failed to collect lock metrics: {e}")
            return {"error": str(e)}
