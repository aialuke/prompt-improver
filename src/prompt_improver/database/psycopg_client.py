...
class QueryMetrics:
    ...
    def record_query(self, query: str, duration_ms: float, params: Optional[Dict] = None):
...
class TypeSafePsycopgClient:
    ...
    async def get_performance_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'performance_status': 'GOOD' if (
                self.metrics.avg_query_time <= self.config.target_query_time_ms and 
                cache_hit_ratio >= self.config.target_cache_hit_ratio
...
_client: Optional[TypeSafePsycopgClient] = None
