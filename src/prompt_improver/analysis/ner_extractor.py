...
class NERExtractor:
    ...
    def __init__(self, use_transformers: bool = True, model_name: Optional[str] = None):
        """
        ...
        self.technical_patterns = {
            "API_ENDPOINT": re.compile(r'\b(?:GET|POST|PUT|DELETE|PATCH)\s+/[\w/\-\?&=]+', re.IGNORECASE),
            "HTTP_STATUS": re.compile(r'\b(?:200|201|400|401|403|404|500)\b'),
            "JSON_OBJECT": re.compile(r'\{[^{}]*\}'),
            "CODE_BLOCK": re.compile(r'```[\s\S]*?```'),
            "FUNCTION_CALL": re.compile(r'\b\w+\([^)]*\)'),
            "FILE_PATH": re.compile(r'(?:[./][\w/\-\.]+|[\w\-\.]+\.(?:py|js|html|css|json|xml|txt))'),
        ...
        self.programming_keywords = {
            ...
            "sql", "html", "css", "json", "xml", "yaml", "markdown",
            "bash", "shell", "powershell", "dockerfile", "kubernetes"
        }
        
        # AI/ML specific terms
        self.ai_ml_terms = {
            "neural", "network", "deep", "learning", "machine", "artificial",
            "intelligence", "model", "training", "inference", "prediction",
            "classification", "regression", "clustering", "supervised",
            "unsupervised", "reinforcement", "transformer", "attention",
            "embedding", "tokenization", "fine-tuning", "pretraining",
            "llm", "gpt", "bert", "roberta", "t5", "llama", "claude"
        }
    ...
    def extract_technical_terms(self, text: str, custom_keywords: Optional[Set[str]] = None) -> List[str]:
        """
    ...
    def get_entity_context(self, text: str, entity_start: int, entity_end: int, 
