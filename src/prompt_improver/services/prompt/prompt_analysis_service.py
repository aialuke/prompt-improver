...
class PromptAnalysisService(PromptAnalysisServiceProtocol):
    ...
    async def analyze_prompt(
        ...
        try:
            ...
            logger.exception(f"Error analyzing prompt {prompt_id}: {e}")
            raise
    ...
    async def generate_improvements(
        ...
        try:
            ...
            logger.exception(f"Error generating improvements: {e}")
            raise
    ...
    async def evaluate_improvement_quality(
        ...
        try:
            ...
            logger.exception(f"Error evaluating improvement quality: {e}")
    ...
    async def get_ml_recommendations(
        ...
        try:
            ...
            logger.exception(f"Error getting ML recommendations: {e}")
