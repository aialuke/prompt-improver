...
class EnhancedStructuralAnalyzer:
    ...
    async def _assess_structural_quality(self, elements: List[StructuralElement], structural_graph: Optional[StructuralGraph], semantic_analysis: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _generate_structural_insights(self, elements: List[StructuralElement], structural_graph: Optional[StructuralGraph], semantic_analysis: Dict[str, Any], discovered_patterns: List[Dict[str, Any]]) -> Dict[str, Any]:
