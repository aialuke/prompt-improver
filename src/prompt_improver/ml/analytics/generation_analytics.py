...
class GenerationHistoryTracker:
    ...
    async def start_tracking_session(self, generation_method: str, target_samples: int, session_type: str='synthetic_data', training_session_id: str | None=None, configuration: dict[str, Any] | None=None, performance_gaps: dict[str, float] | None=None, focus_areas: list[str] | None=None) -> str:
    ...
    async def track_batch_completion(self, session_id: str, batch_number: int, batch_size: int, generation_method: str, processing_time: float, samples_generated: int, samples_filtered: int=0, error_count: int=0, quality_metrics: dict[str, float] | None=None, performance_metrics: dict[str, float] | None=None) -> str:
    ...
    async def complete_session(self, session_id: str, final_sample_count: int, status: str='completed', error_message: str | None=None) -> None:
...
class GenerationAnalytics:
    ...
    async def get_performance_trends(self, days_back: int=30, method_name: str | None=None) -> dict[str, Any]:
    ...
    async def get_effectiveness_report(self, session_id: str | None=None, days_back: int=7) -> dict[str, Any]:
