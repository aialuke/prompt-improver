...
class WorkflowTemplates:
    ...
    def get_continuous_training_workflow() -> WorkflowDefinition:
        ...
        return WorkflowDefinition(
            ...
            description="Self-improving training loop with performance gap analysis and intelligent stopping",
            steps=[
                WorkflowStep(
                    ...
                    parameters={
                        ...
                        "metrics": ["effectiveness", "consistency", "coverage"],
                        "window_size": 10
                    },
                    timeout=300
                ),
                ...
                WorkflowStep(
                    step_id="evaluate_stopping_criteria",
                    name="Evaluate Stopping Criteria",
                    component_name="stopping_criteria_evaluator",
                    parameters={
                        "correlation_driven": True,
                ...
                WorkflowStep(
                    ...
                    dependencies=["evaluate_stopping_criteria"],
                    timeout=600
                ),
                WorkflowStep(
                ...
                WorkflowStep(
                    step_id="optimize_rules",
                    name="Optimize Rules with Gaussian Process",
                    component_name="rule_optimizer",
                    parameters={
            ...
            max_iterations=None,  # Unlimited iterations (stopped by criteria)
            ...
            metadata={
                ...
                "best_practices": "correlation_driven_stopping",
                "optimization_method": "gaussian_process",
                "data_generation": "gap_targeted"
            }
        )
    ...
    def get_all_workflow_templates() -> List[WorkflowDefinition]:
        ...
        return [
            ...
            WorkflowTemplates.get_continuous_training_workflow()
        ]
