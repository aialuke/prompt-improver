...
class DirectComponentLoader:
    ...
    def __init__(self):
        ...
        self.component_paths = {
            ComponentTier.TIER_1_CORE: {
                ...
                "synthetic_data_generator": "prompt_improver.ml.preprocessing.synthetic_data_generator",
            },
            ...
            ComponentTier.TIER_4_PERFORMANCE: {
                ...
                "unified_retry_manager": "prompt_improver.ml.orchestration.core.unified_retry_manager",
    ...
    def _find_main_class(self, module: Any, component_name: str) -> Optional[Type]:
        ...
        specific_mappings = {
            ...
            "unified_retry_manager": "UnifiedRetryManager",
            ...
            "fernet_key_manager": "FernetKeyManager",
