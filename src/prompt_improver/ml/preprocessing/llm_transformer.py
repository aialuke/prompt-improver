...
class ConfigurablePatternProvider:
    ...
    def __init__(self, config_path: Path | None=None):
        ...
        self._cached_patterns: dict[str, Any] | None = None
...
class MLPatternProvider:
    ...
    def __init__(self, model_path: Path | None=None, config: TransformationConfig | None=None):
    ...
    async def _generate_ml_patterns(self) -> dict[str, Any] | None:
...
class LLMTransformerService:
    ...
    def __init__(self, config: TransformationConfig | None=None):
    ...
    async def enhance_clarity(self, prompt: str, vague_words: list[str], context: dict[str, Any] | None=None) -> dict[str, Any]:
    ...
    async def enhance_specificity(self, prompt: str, context: dict[str, Any] | None=None) -> dict[str, Any]:
    ...
    async def _find_best_replacement_async(self, vague_word: str, prompt: str, pattern_info: dict[str, Any], context: dict[str, Any] | None=None) -> str | None:
    ...
    async def _generate_clarity_guidance_async(self, prompt: str, vague_words: list[str], patterns: dict[str, Any]) -> str | None:
    ...
    def _suggest_format_specification(self, prompt: str, context: dict[str, Any] | None=None) -> str | None:
    ...
    def _suggest_constraints(self, prompt: str, context: dict[str, Any] | None=None) -> str | None:
    ...
    def _generate_examples(self, prompt: str, context: dict[str, Any] | None=None) -> str | None:
