...
class PerformanceBenchmarkResult:
    ...
    performance_improvement_ratio: float | None = None
    ...
    async def _benchmark_prompt_improvement(
        ...
        for i in range(test_iterations):
            ...
            try:
                ...
                self.logger.exception(f"Prompt improvement test iteration {i} failed: {e}")
    ...
    async def _benchmark_analytics_queries(
        ...
        for i in range(test_iterations):
            ...
            try:
                ...
                self.logger.exception(f"Analytics query test iteration {i} failed: {e}")
                response_times.append(10000)  # Penalty for failure
    ...
    async def _benchmark_ml_inference(
        ...
        for i in range(test_iterations):
            ...
            try:
                ...
                self.logger.exception(f"ML inference test iteration {i} failed: {e}")
                response_times.append(10000)  # Penalty for failure
    ...
    async def _benchmark_health_checks(
        ...
        for i in range(test_iterations):
            ...
            try:
                ...
                self.logger.exception(f"Health check test iteration {i} failed: {e}")
                response_times.append(10000)  # Penalty for failure
    ...
    async def _benchmark_postgres_pool(
        ...
        for i in range(test_iterations):
            ...
            try:
                ...
                self.logger.exception(f"Postgres pool test iteration {i} failed: {e}")
                response_times.append(10000)  # Penalty for failure
    ...
    async def _benchmark_cache_performance(
        ...
        for i in range(test_iterations):
            ...
            try:
                ...
                self.logger.exception(f"Cache test iteration {i} failed: {e}")
                response_times.append(10000)  # Penalty for failure
