        ...
        try:
            ...
            return HealthResult(
                ...
                details={
                    ...
                    if hasattr(self._orchestrator, "state")
                    else "unknown",
                },
                timestamp=start_time,
    ...
    async def check(self) -> HealthResult:
        ...
        try:
            ...
            workflow_definitions = (
                await self._workflow_engine.list_workflow_definitions()
            )
            ...
            if failed_workflows:
                ...
                status = HealthStatus.HEALTHY
                message = (
                    f"Workflow engine healthy with {active_executors} active workflows"
                )
            else:
                status = HealthStatus.HEALTHY
