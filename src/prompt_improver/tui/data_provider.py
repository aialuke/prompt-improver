...
class APESDataProvider:
    ...
    async def get_automl_status(self) -> dict[str, Any]:
        ...
        try:
            ...
            automl_data = {
                ...
                "optimization_time": status.get("optimization_time", 0),
                "trials_completed": status.get("trials_completed", 0),
                "trials_failed": status.get("trials_failed", 0),
                "current_objective": status.get("current_objective", "accuracy"),
    ...
    def _calculate_uptime(self) -> str:
        ...
        uptime_hours = 24 * 7 + 5  # 7 days, 5 hours
