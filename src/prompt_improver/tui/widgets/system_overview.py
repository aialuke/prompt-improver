...
class SystemOverviewWidget(Static):
    ...
    def on_mount(self) -> None:
        ...
        try:
            ...
            self.logger.error('Failed to mount SystemOverviewWidget: %s', e)
    ...
    async def update_data(self, data_provider) -> None:
        ...
        try:
            ...
            self.logger.error('Failed to update system overview data: %s', e)
    ...
    def update_display(self) -> None:
        ...
        try:
            ...
            self.logger.error('Failed to update system overview display: %s', e)
            error_content = Panel(f'[red]Display Error: {e!s}[/red]', title='System Overview')
    ...
    def _safe_update_content(self, content: Any) -> None:
        ...
        try:
            ...
            self.logger.debug('Widget not mounted yet, storing content: %s', e)
    ...
    def _get_status_color(self, status: str) -> str:
        ...
        status_colors = {'online': 'green', 'warning': 'yellow', 'error': 'red', 'offline': 'red', 'initializing': 'blue'}
    ...
    async def start_auto_refresh(self, interval: float=None) -> None:
        ...
        task_id = await task_manager.submit_enhanced_task(task_id=f'tui_refresh_{widget_id}', coroutine=self._auto_refresh_loop, priority=TaskPriority.LOW, tags={'service': 'tui_widgets', 'type': 'auto_refresh', 'widget': 'system_overview'})
    ...
    async def _auto_refresh_loop(self) -> None:
        ...
        try:
            ...
            self.logger.error('Auto-refresh error: %s', e)
