"""Shared protocol definitions for the prompt-improver system.

This module contains protocol interfaces that define contracts
for various system components, helping to break circular dependencies.
"""
from abc import abstractmethod
from collections.abc import Mapping
from typing import Any, Dict, List, Optional, Protocol, runtime_checkable
from prompt_improver.common.types import ConfigDict, ConnectionParams, HealthCheckResult, MetricPoint, SecurityContext
...
class RetryManagerProtocol(Protocol):
    ...
    @abstractmethod
    async def retry_operation(self, operation: Any, max_retries: int | None=None, backoff_factor: float | None=None) -> Any:
