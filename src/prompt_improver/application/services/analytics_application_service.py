...
class AnalyticsApplicationService:
        ...
        try:
            ...
            async with self.db_services.get_session() as db_session:
                try:
                    ...
                    self.logger.exception(f"Dashboard data generation failed: {e}")
                    raise

        except Exception as e:
            self.logger.exception(f"Dashboard workflow failed: {e}")
            return {
                "status": "error",
                "error": str(e),
                "timestamp": datetime.now(UTC).isoformat(),
        ...
        try:
            ...
            async with self.db_services.get_session() as db_session:
                try:
                    ...
                    self.logger.exception(f"Trend analysis execution failed: {e}")
                    raise

        except Exception as e:
            self.logger.exception(f"Trend analysis workflow failed: {e}")
            return {
                "status": "error",
                "error": str(e),
                "timestamp": datetime.now(UTC).isoformat(),
    ...
    async def execute_session_comparison(
        ...
        try:
            ...
            self.logger.exception(f"Session comparison workflow failed: {e}")
            return {
                "status": "error",
                "error": str(e),
                "timestamp": datetime.now(UTC).isoformat(),
    ...
    async def generate_session_summary(
        ...
        try:
            ...
            self.logger.exception(f"Session summary workflow failed: {e}")
            return {
                "status": "error",
                "error": str(e),
                "session_id": session_id,
    ...
    async def export_session_report(
        ...
        try:
            ...
            self.logger.exception(f"Session export workflow failed: {e}")
            return {
                "status": "error",
                "error": str(e),
                "session_id": session_id,
    ...
    async def _generate_comparison_data(
        ...
        try:
            ...
            previous_end = datetime.now(UTC) - timedelta(hours=time_range_hours)
            ...
            self.logger.exception(f"Comparison data generation failed: {e}")
    ...
    async def _calculate_performance_indicators(
        ...
        try:
            ...
            self.logger.exception(f"Performance indicator calculation failed: {e}")
            return {}
    ...
    async def _calculate_trend_analytics(
        ...
        try:
            ...
            self.logger.exception(f"Trend analytics calculation failed: {e}")
            return {}
