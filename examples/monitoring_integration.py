...
from prompt_improver.monitoring.http.unified_http_middleware import UnifiedHTTPMetricsMiddleware
...
app.add_middleware(UnifiedHTTPMetricsMiddleware, enable_in_memory_analytics=True, journey_labels='hashed')
...
def update_business_metrics():
    ...
    business_metrics.record_user_activity(user_id=f'user_{active_users}', activity_type='active_session')
    business_metrics.record_feature_flag_evaluation(flag_name='prompt_improvement_clarity', enabled=True)
    business_metrics.record_feature_flag_evaluation(flag_name='prompt_improvement_specificity', enabled=True)
