...
async def debug_mcp_startup():
    ...
    process = subprocess.Popen([sys.executable, 'src/prompt_improver/mcp_server/mcp_server.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, bufsize=1, env=env)
    try:
                ...
                if response_line:
                    ...
                    if 'result' in response:
                        ...
                        if tools:
                            ...
                            tool_call = {'jsonrpc': '2.0', 'id': 3, 'method': 'tools/call', 'params': {'name': tool_name, 'arguments': {}}}
