...
class MCPIntegrationTester:
    ...
    def _identify_server_type(self, server_name: str, server_config: Dict[str, Any]) -> str:
        ...
        elif "context7" in name_lower:
            return "context7"
        elif "memory" in name_lower:
            return "memory"
        elif "browser" in name_lower or "hyperbrowser" in name_lower:
            return "hyperbrowser"
    ...
    def run_comprehensive_test(self, server_filter: Optional[str] = None, verbose: bool = False) -> List[MCPTestResult]:
        ...
        for server_name, server_config in servers_to_test.items():
            ...
            if connectivity_result.success:
                ...
                print(f"   ⏭️ Skipping tool/performance tests due to connectivity failure")
