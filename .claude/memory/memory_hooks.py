...
class AgentMemoryHooks:
    ...
    def detect_agent_from_context(self, task_prompt: str) -> str | None:
    ...
    def pre_task_memory_load(self, task_prompt: str, explicit_agent: str | None = None) -> dict[str, Any]:
    ...
    def post_task_memory_update(self, task_outcome: str, insights: list[str] | None = None,
                               delegations: list[dict[str, str]] | None = None,
                               optimization_area: str | None = None,
    ...
    def send_cross_agent_insight(self, message_type: str, content: str,
                                ...
                                from_agent: str | None = None) -> str | None:
    ...
    def get_collaboration_recommendations(self, agent_name: str | None = None) -> dict[str, Any]:
...
def load_agent_context(task_prompt: str, explicit_agent: str | None = None) -> dict[str, Any]:
...
def update_agent_memory(task_outcome: str, insights: list[str] | None = None,
                       delegations: list[dict[str, str]] | None = None,
                       optimization_area: str | None = None,
                       optimization_insight: str | None = None,
                       optimization_impact: str = "medium",
...
def get_agent_collaboration_tips(agent_name: str | None = None) -> dict[str, Any]:
