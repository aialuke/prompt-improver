...
class AgentMemoryManager:
    ...
    def _find_existing_schemas_directory(self) -> Path | None:
    ...
    def _load_agent_schema(self) -> dict[str, Any]:
        ...
        try:
            with open(schemas_dir / "agent_memory_schema.json", encoding="utf-8") as f:
                return json.load(f)
    ...
    def _load_shared_context_schema(self) -> dict[str, Any]:
        ...
        schemas_dir = self._get_schemas_directory()
        try:
            with open(schemas_dir / "shared_context_schema.json", encoding="utf-8") as f:
                return json.load(f)
        except FileNotFoundError as e:
    ...
    def load_shared_context(self) -> dict[str, Any]:
        ...
        try:
            with open(self.shared_context_file, encoding="utf-8") as f:
    ...
    def add_inter_agent_message(self, from_agent: str, message_type: str,
                               content: str, target_agents: list[str] | None = None,
