...
class AutoMemoryUpdater:
    ...
    def infer_delegation_target(self, trigger: str, current_agent: str) -> str | None:
    ...
    def analyze_task_outcome(self, task_description: str, response_text: str,
                           execution_time: float | None = None) -> str:
        ...
        if len(response_text) > 100:  # Substantial response
            return "success"
        if execution_time and execution_time > 30:  # Long execution suggests effort
            return "partial"

        return "partial"  # Default conservative outcome

    def auto_update_memory(self, agent_name: str, task_description: str,
                          response_text: str, execution_time: float | None = None,
        ...
        try:
            ...
            if insights["delegations"]:
                ...
                all_delegations.extend(delegation for delegation in insights["delegations"] if delegation["to_agent"] not in explicit_targets)
